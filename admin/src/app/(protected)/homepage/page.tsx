      ...
      <section className="rounded-lg border bg-white p-6">
        <div className="mb-4 space-y-2">
          ...
          <ul className="list-disc space-y-1 rounded-md bg-blue-50 p-3 pl-8 text-xs text-blue-900">
            <li>
              各タグ枠に出る議案3件は、<strong>📌固定した議案が先頭</strong>
              に並び、残りの枠は<strong>自動選定</strong>
              （興味度スコアが高い順）で埋まります
            </li>
            <li>
              「この議案をこのタグ枠に必ず出したい」ときは、枠内の議案の
              <strong>「固定する」ボタン</strong>
              を押すだけです（今出ていない議案も「今出ていない議案をこの枠に固定する」から選べます）。固定・解除はすぐ保存され、公開サイトに反映されます
            </li>
            <li>
              タグに関係なくトップページの最上部に出したい議案は、上の「注目の議案」に追加してください（注目に入れた議案はタグ枠から自動で除外され、重複表示されません）
            </li>
            <li>
