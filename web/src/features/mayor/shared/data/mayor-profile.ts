...
export const MAYOR_ACTIONS: readonly TimelineEvent[] = [
  ...
  {
    date: "2026-08-10",
    title: "8月臨時会に議案2件を提出、副市長に盛坪達人氏",
    description: `前市長・${FORMER_MAYOR_NAME}氏の給料5割減額の期間を退職日の5月31日までに短縮する条例改正と、新しい副市長に盛坪達人氏（当時の教育部長）を選任することへの同意を求める議案を提出し、いずれも可決されました。副市長の選任は無記名投票で賛成13票・反対4票。本会議の冒頭では就任のあいさつを行いました。`,
    source: {
      kind: "meeting",
      committeeName: "本会議",
  ...
  },
  {
    ...
    source: {
      kind: "meeting",
      committeeName: "本会議（一般質問）",
      meetingDate: "2026-09-09",
    },
  },
  {
    date: "2026-09-10",
    title: "一般質問2日目、「平成筑豊鉄道を残したい」と答弁",
    description:
  ...
  {
    date: "2026-09-11",
    title: "一般質問3日目、防犯灯の電気代の公費負担を前向きに検討",
    description:
...
/**
 * 会期中（または次に控える）定例会の案内。9月7日の本会議（所信表明・議案の提案）と
 * 公式サイトの会期日程表に基づく。会期が終わると表示されなくなる（判定はローダー側）
 * ので、終わったら次の定例会の内容に書き換えるか、この定数ごと消す
 */
