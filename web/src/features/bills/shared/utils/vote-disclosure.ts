 ...
 * - 無記名投票で採決された8議案（不信任決議・辞職勧告・副市長の選任など）は、
 *   市も議員別の賛否を公表していない（賛否は分かれている）
 ...
 * 27会期で公開、121議案転記済み・無記名投票7件は市も非公開。2026年8月の
 * 副市長選任〔賛成13・反対4〕で8件目）
 */
...
const SECRET_BALLOT_BILL_KEYS: ReadonlySet<string> = new Set([
  ...
  // 令和8年8月臨時会。無記名投票で賛成13票・反対4票（本会議中継より）
  "r8-5-rinji:議案第49号　田川市副市長の選任について（盛坪 達人 氏）",
]);
