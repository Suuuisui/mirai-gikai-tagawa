...
function _InterviewBadge() {
  return (
    <div className="flex">
      <div className="inline-flex items-center justify-center gap-2 px-3 py-1 bg-mirai-surface-tag rounded-lg">
...
function _InterviewCTAButton({ billId }: { billId: string }) {
  return (
    ...
    >
      <Button className="w-full h-[42px] px-5 font-bold text-sm gap-1">
